...
czech_data_csv <- "Otevrena-data-NR-26-30-COVID-19-prehled-populace-2024-01.csv"
...
my_czech_header <- c("Infekce", "Pohlavi", "RokNarozeni", "Datum_Prvni_davka", "DatumUmrtiLPZ")
...
english_header <- c(
  ...
  "birth_year", # birth year category (5-year bins), string
  "date_positive", # year and ISO week of positive test, string
  "date_result", # year and ISO week of test result, string
  ...
  "date_dose1", # year and ISO week of first dose, string
  "date_dose2",
  "date_dose3",
  "date_dose4",
  "date_dose5",
  ...
  "date_of_death_registry", # week of death in registry, string
