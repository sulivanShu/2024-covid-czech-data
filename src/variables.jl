...
my_czech_header = ["Infekce", "Pohlavi", "RokNarozeni", "Datum_Prvni_davka", "DatumUmrtiLPZ"]
my_english_header = ["infection_rank", "sex", "_5_years_cat_of_birth", "week_of_dose1", "week_of_death"]
