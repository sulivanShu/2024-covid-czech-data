...
MyCzechHeader = c("Infekce","Pohlavi","RokNarozeni","Datum_Prvni_davka","DatumUmrtiLPZ")
MyEnglishHeader = c("infection","sex","birth_year","date_dose1","date_of_death_registry")
